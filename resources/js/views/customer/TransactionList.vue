<template>
    ...
    <div class="breadcrumb flex items-end border-b border-gray-300 pb-4 mb-6">
        <p class="text-xl mr-1 font-semibold mr-2">Customer Transaction List</p>
        <ul>
            <li class="border-r border-gray-400 inline pr-2 dark:text-gray-400">Customer</li>
            <li class="inline pl-2 dark:text-gray-400">Customer Transaction List</li>
        </ul>
    </div>
    ...
    export default{
        ...
        created(){
            ...
            const data={'id':id}
            this.id=id
            axios.post('/api/customerindividualtransaction',data).then(response=>{
        ...
        methods:{
            getResults(page = 1) {
                const id=this.id
                const data={'id':id}
                axios.post('/api/customerindividualtransaction?page=' + page,data)
                    .then(response => {
                        this.items = response.data;
                    });
            },
            ...
            filter(){
                ...
                console.log(data);
                axios.post('/api/customerindivudualtransactionfilter',data).then(response=>{
                    this.items = response.data;
                }).catch(error=>{
                    console.log(error)
                });
