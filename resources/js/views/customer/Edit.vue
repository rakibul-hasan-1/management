...
export default{
    ...
    created(){
        ...
        const id = route.params.id
            const data={'id':id}
            axios.post('/api/customer/edits',data).then(response=>{
    ...
    methods:{
        update(){
            this.create=true            
            const data={'id':this.id,'name':this.name,'status':this.status,'phone':this.phone,'email':this.email,'address':this.address,'type':this.type,'rank':this.rank}
            axios.post('/api/customer/update',data).then(response=>{
                console.log(response);
